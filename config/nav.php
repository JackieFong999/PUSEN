    ...
    'sections' => [
        ...
        'Browse' => [
            ...
            'items' => [
                ...
                ['label' => 'Create SEN',  'icon' => 'bi-window-sidebar',        'color' => 'ic-green',  'href' => '#'],
                ...
                [
                    ...
                    'children' => [
                        ...
                        ['label' => 'Student Status',     'icon' => 'bi-keyboard',  'color' => 'ic-green', 'href' => '#'],
                        ['label' => 'Subject Type',     'icon' => 'bi-window-sidebar',  'color' => 'ic-blue', 'href' => '#'],
                        ['label' => 'Advisor Type',     'icon' => 'bi-layout-sidebar-inset',  'color' => 'ic-pink', 'href' => '#'],
                        ['label' => 'SEN Type',     'icon' => 'bi-star',  'color' => 'ic-yellow', 'href' => '#'],
                        ['label' => 'Academic Year Semester',     'icon' => 'bi-signpost-split',  'color' => 'ic-cyan', 'href' => '#'],
                    ],
                ],
