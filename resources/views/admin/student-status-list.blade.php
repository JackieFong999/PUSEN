...
<div class="page-header d-flex flex-wrap align-items-end justify-content-between gap-3 mb-4">
  <div>
    <h1 class="mb-1">Student Status</h1>
    <p>Student statuses used in the system — retrieved from <code>tblStudent_Status</code>.</p>
  </div>
</div>
...
<div class="text-center mt-4">
  <span style="font-size:.78rem; color:var(--text-faint);">
    <i class="bi bi-database me-1"></i>{{ count($statuses) }} record(s) from PUSENDB.tblStudent_Status
  </span>
</div>
