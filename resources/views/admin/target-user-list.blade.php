...
<div class="crumb mb-3">
  ...
  <span>Target User List</span>
</div>

<div class="page-header d-flex flex-wrap align-items-end justify-content-between gap-3 mb-4">
  <div>
    <h1 class="mb-1">Target User List</h1>
    <p>Target user groups defined in the system — retrieved from <code>tblTarget_User</code>.</p>
  </div>
</div>
...
<div class="text-center mt-4">
  <span style="font-size:.78rem; color:var(--text-faint);">
    <i class="bi bi-database me-1"></i>{{ count($targetUsers) }} record(s) from PUSENDB.tblTarget_User
  </span>
</div>
